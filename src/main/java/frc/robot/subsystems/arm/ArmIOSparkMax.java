...
public class ArmIOSparkMax {
    ...
    // arm motor
    private final CANSparkMax armMotor = new CANSparkMax(15,MotorType.kBrushless);
    private final RelativeEncoder armEncoder = armMotor.getEncoder();
    private final DigitalInput m_hallEffect = new DigitalInput(2);
    private final SparkPIDController armPid = armMotor.getPIDController();

    private final CANSparkMax wheelsMotor = new CANSparkMax(16, MotorType.kBrushless);

    private final CANSparkMax wristMotor = new CANSparkMax(17, MotorType.kBrushless);
