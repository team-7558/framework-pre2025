...
public class ElevatorWithArmIOSim implements ElevatorWithArmIO {
  ...
  private PIDController pidElev = new PIDController(10, 0, 0);
  ...
  public void updateInputs(ElevatorWithArmIOInputs inputs) {
    ...
    inputs.appliedVoltsElev =
        MathUtil.clamp(pidElev.calculate(sim.getPositionMeters()), -12.0, 12.0);
    ...
    inputs.elevPositionM = sim.getPositionMeters();
