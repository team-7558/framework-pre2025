...
public class Robot extends LoggedRobot {
  ...
  public void robotPeriodic() {
    ...
    if (OI.DR.getAButton()) {
      ...
      intake.queueState(IntakeStates.INTAKING);
    } else if (OI.DR.getYButton()) {
      intake.queueState(IntakeStates.SPITTING);
    } else if (OI.DR.getBButton()) {
      intake.queueState(IntakeStates.STOPPED);
    } else {
      intake.queueState(IntakeStates.HOLDING);
